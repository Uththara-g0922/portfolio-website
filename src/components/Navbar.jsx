...
const Navbar = ({ darkMode, toggleDarkMode }) => {
  ...
  return (
    <div className="fixed z-50 flex justify-center w-full mt-4">
      <motion.nav
        initial={{ y: -100 }}
        animate={{ y: 0 }}
        transition={{ duration: 0.5 }}
        className={`flex items-center justify-center ${colors.navBg} backdrop-blur rounded-2xl px-4 lg:px-8 py-2 shadow-lg`}
      >
        ...
        {isMenuOpen && (
          ...
          ${darkMode
            ...
            <div className="px-4 py-3 space-y-2">
              ...
              whileTap={{ scale: 0.95}}
              className={`block py-3 px-4 text-center font-semibold rounded-lg bg-linear-to-r ${colors.button} text-while shadow-md`}>
                Hire Me
              </motion.a>
            </div>
