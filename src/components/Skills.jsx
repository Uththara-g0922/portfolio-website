...
const Skills = ({darkMode}) => {
  const skills = [
    ...
    {name:'vite', icon: vite, level: 92, color: 'from-red-500 to-orange-500'},
  ];
  return (
    <section
    id="skills"
        ...
        >
          {skills.map((skills,index) => (
            ...
            data-aos-delay={`${300 + index * 100}`}>
              <div style={{ background: darkMode ?'linear-gradient(to bottom right, #1f2937, #111827)'
                ...
                className='h-full p-6 rounded-2xl border hover:border-orange-500/50 transition-all duration-300 hover:-translate-y-2 group hover:shadow-[0_0_30px_rgb(255, 165,0,0.15)]'>
                  <div className='flex items-center mb-6'>
                    <div style={{ background: darkMode ?'linear-gradient(to bottom right, #374151, #1f2937)'
